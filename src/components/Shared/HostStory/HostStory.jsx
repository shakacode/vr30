  ...
  <div className={css.container}>
    ...
    <div className={css.innerContainer}>
      ...
      <div className={css.description}>
        ...
        listings. On August 1st, 2019, Bill 89 passed and became law. Oahu hosts
        had to switch to 30 minimum stays, but the big listings sites don't
        attract many visitors interested in doing 30+ day stays. The owners and
        managers need an alternative marketing source. Richard gets back into
        high gear with building VR30.rent, but realizes that it's tough to build
        good technology. Common friends introduce Richard to Justin Gordon who
        founded{" "}
        ...
        , since 2015. It immediately became clear to both of them that they
        should partner up! So Richard has joined Hawaii Chee as the “Manager of
        Oahu Operations,” responsible for building the Oahu and overall Hawaii
        inventory for Hawaii Chee (and VR30.rent).
